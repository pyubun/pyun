...
class PlaneGame(object):
    ...
    def __written_words(self):
        """显示积分"""

        y = self.integral

        # 实例化对象
        text = pygame.font.SysFont("taf.ttf", 25)

        # 渲染文字
        text_fmt = text.render("integral: %s" % y, 1, (0, 0, 0), (255, 255, 255))

        # 渲染到屏幕
        self.screen.blit(text_fmt, (0, 0))
